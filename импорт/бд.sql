...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'SportAchievementDB')
BEGIN
    CREATE DATABASE [SportAchievementDB]
END
GO
...
-- Связующая таблица Студент_Достижение (многие ко многим)
...
-- =====================================================
-- 6. Функции и представления
-- =====================================================

-- Функция для вычисления текущего курса
...
-- Представление: информация о группах
...
-- Представление: информация о студентах
...
-- Представление: информация о преподавателях
...
-- Представление: достижения студентов (с использованием FOR XML PATH вместо STRING_AGG)
...
-- Функция для получения достижений студента (без STRING_AGG)
